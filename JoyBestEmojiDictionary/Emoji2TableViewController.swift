...
class Emoji2TableViewController: UITableViewController {
    ...
    var emojis: [Emoji] = [
        ...
        Emoji(symbol: "👮🏾‍♀️", name: "Police Officer", description: "A police officer wearing a blue cap with gold badge.", usage: "person of authority"),
        Emoji(symbol: "🐢", name: "Turtle", description: "A cute turtle", usage: "Something slow"),
        Emoji(symbol: "🐘", name: "Elephant", description: "A gray elephant", usage: "good memory"),
        Emoji(symbol: "🍝", name: "Spaghetti", description: "A plate of spahghetti", usage: "spaghetti"),
